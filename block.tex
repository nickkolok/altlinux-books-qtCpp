...
\usepackage[
	...
	breaklinks=true,
	linkcolor=blue
]{hyperref}%Кликабельные ссылки - актуально для электронной версии
...
среде \Sys{Qt Creator}. Также в книге описаны среда программирования \Sys{Qt Creator}, редактор \Sys{Geany}, кроссплатформенная библиотека
...
\legalnotice{Материалы, составляющие данную книгу, распространяются на условиях лицензии GNU FDL.
	...
	\url{http://git.altlinux.org/people/black/packages/?p=books-qtCpp.git}
	\smallskip
}
